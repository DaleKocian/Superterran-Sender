...
import io.gamejam.poundcode.superterran.view.JoystickMovedListener;

/**
 * https://github.com/zerokol/JoystickView
 */
public class JoyStickControllerView extends View implements Runnable {
    // Constants
    private final double RAD = 57.2957795;
    public final static long DEFAULT_LOOP_INTERVAL = 100; // 100 ms
    // Variables
    private JoystickMovedListener onJoystickMoveListener; // Listener
    ...
    public JoyStickControllerView(Context context) {
        super(context);
    }

    public JoyStickControllerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJoystickView();
    }

    public JoyStickControllerView(Context context, AttributeSet attrs, int defaultStyle) {
    ...
    public void setOnJoystickMoveListener(JoystickMovedListener listener,
                                          long repeatInterval) {
